...
saveRDS(geneLists, file = "results/rds/genelists-vsmc-mimics.rds")
...
saveRDS(fgseaResults, file = "results/rds/vsmc-fgsea-mimics.rds")
...
write.csv(fgseaResultsSig, file = "results/tables/fgsea-vsmc-sigNES-mimics.csv")
############################################