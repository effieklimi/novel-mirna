...
clusters <- cut_lower_fun(as.dendrogram(distances), h = 9.34)
#9.13 -> 6 clusters (212-618). median = 385.5 -> this is best, with 7 clusters, 2 clusters had same go terms
#9.05 -> 7 clusters (212-428). median = 364
#9.02 -> 8 clusters (212-406). median = 242
length(clusters)
...
# heatmap
pdf("results/figures/deseq-heatmap-clusters-hclust-6.pdf", width = 7, height = 10)
...
saveRDS(geneOntologyTable, file = "results/rds/vsmc-deseq-gobp-hclust-6-lfc-filtered.rds")
...
saveRDS(bpSimplify, file = "results/rds/vsmc-deseq-gobp-hclust-6-lfc-filtered-simplified.rds")
#



# GO term dot plots
pdf(file = "results/figures/vsmc-multimir-gobp-cluster1-hclust.pdf", width = 7, height = 12)
...
pdf(file = "results/figures/vsmc-multimir-gobp-cluster2-hclust.pdf", width = 7, height = 12)
...
pdf(file = "results/figures/vsmc-multimir-gobp-cluster3-hclust.pdf", width = 7, height = 12)
dotplot(geneOntology[[3]], showCategory = 20) +
...
pdf(file = "results/figures/vsmc-multimir-gobp-cluster4-hclust.pdf", width = 7, height = 12)
dotplot(geneOntology[[4]], showCategory = 20) +
