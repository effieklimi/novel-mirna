...
write.csv(fpkm, file = "/Users/effieklimi/Documents/novel-mirna/results/tables/endosExpressed.csv")

deseq <- readRDS("results/rds/endos-deseq2.rds")
genes <- 
...
saveRDS(targets50Top2, file = "/Users/effieklimi/Documents/novel-mirna/results/rds/endos-multimir.rds")
